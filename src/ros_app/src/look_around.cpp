...
namespace ros_app {
    ...
    look_around::look_around(/* args */) : _nh("~") {
...
int main(int argc, char** argv) {
    ...
    ros::NodeHandle nh("~");
    ros_app::look_around lk;
    ros::ServiceServer service = nh.advertiseService("tiago_look_around", &ros_app::look_around::tiagoCallback, &lk);
    ros::spin();
    return 0;
