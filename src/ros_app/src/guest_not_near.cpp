#include "guest_not_near.h"

namespace ros_app {
    guest_not_near_SensorInterface::guest_not_near_SensorInterface() : _nh("~") {
        pub = _nh.advertise<std_msgs::Bool>("guest_not_near", 1, false);
    }

    bool guest_not_near_SensorInterface::concreteCallback(const rosplan_dispatch_msgs::SensorDispatch::ConstPtr& msg) {
...
int main(int argc, char** argv) {
    ...
    ros_app::guest_not_near_SensorInterface dsi;
