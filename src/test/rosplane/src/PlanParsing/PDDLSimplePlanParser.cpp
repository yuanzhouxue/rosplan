#include "PlanParsing/PDDLSimplePlanParser.h"
...
namespace rosplane {
     ...
     */
    bool PDDLSimplePlanParser::parsePlanFromString(rosplane::ParsingStringSimple::Request& req, rosplane::ParsingStringSimple::Response& res) {
...
int main(int argc, char** argv) {
    ...
    rosplane::PDDLSimplePlanParser pp(nh);
    ...
    ros::ServiceServer service3 = nh.advertiseService("parse_plan_from_string", &rosplane::PDDLSimplePlanParser::parsePlanFromString, &pp);
