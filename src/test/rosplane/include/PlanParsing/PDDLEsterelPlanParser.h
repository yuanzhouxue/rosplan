...
#include "rosplane/ParsingStringEsterel.h"
...
#ifndef rosplane_pddl_esterel_plan_parser
#define rosplane_pddl_esterel_plan_parser
...
namespace rosplane {
    ...
    public:
        ...
        bool parsePlanFromString(rosplane::ParsingStringEsterel::Request& req, rosplane::ParsingStringEsterel::Response& res);
