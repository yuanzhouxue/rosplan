...
namespace KCL_rosplan {
    ...
    RPMoveBase::RPMoveBase(std::string &actionserver) : action_client_(actionserver, true) {
        ...
        service = nh.advertiseService("my_goto_service", &RPMoveBase::callback, this);
    }

    bool RPMoveBase::callback(tiago_despot::ActionSrv::Request& req, tiago_despot::ActionSrv::Response& res) {
